...
rating: 4.4
pros:
  - "Deepest Shopify integration of any email platform — pulls product, order, browse, and cart data in real time"
  - "Predictive analytics (likely-to-buy, churn risk, next order date) are genuinely useful, not gimmicks"
  - "Abandoned cart flows are the industry gold standard — pre-built and conversion-optimized"
  - "Email + SMS in one platform with unified contact profiles and cross-channel automation"
  - "Segment builder is the most powerful in the category — filter by 200+ e-commerce events"
cons:
  - "Expensive for non-e-commerce businesses — you pay for features you'll never use"
  - "SMS costs add up fast at $0.02-0.08 per message — a 10K-subscriber campaign can run $200-800"
  - "Steeper learning curve than MailerLite or Mailchimp — expect 1-2 weeks to feel productive"
  - "Free tier only covers 250 contacts with a 500 emails/mo cap — restrictive vs Brevo or MailerLite"
  - "Overkill for service businesses, creators, and B2B — pay $45+/mo for online-store features"
...
bestFor: "E-commerce stores doing $100k+ annual revenue with active Shopify, WooCommerce, or BigCommerce stores who need deep product integration"
...
- E-commerce stores doing $100K+ annual revenue with active Shopify, WooCommerce, or BigCommerce stores
- DTC brands running both email AND SMS marketing (Klaviyo unifies both in one contact profile)
- Stores that want pre-built e-commerce automation flows (abandoned cart, post-purchase, win-back, browse abandonment)
- Brands that care about predictive analytics — likelihood to purchase, predicted next order date, churn risk
- Marketing teams comfortable with a steeper, more powerful interface than MailerLite or Mailchimp

## Who Klaviyo is NOT for

- Service businesses (consultants, agencies, local shops, SaaS) — Klaviyo is built for online stores, period
- Creators and newsletter writers — use Kit or MailerLite, both are cleaner and 80% cheaper
- New e-commerce stores doing under $50K/year — Klaviyo's pricing assumes revenue scale you don't have yet
- Anyone who only sends newsletters and doesn't need product/cart/browse data — you'll pay for unused features
...
| List size | Email plan | SMS cost |
|---|---|---|
| 0–250 contacts | Free (500 emails/mo cap) | Pay-as-you-go |
| 251–500 contacts | $45/mo | Pay-as-you-go |
| 501–1,000 contacts | $60/mo | Pay-as-you-go |
| 1,001–1,500 contacts | $90/mo | Pay-as-you-go |
| 5,000+ contacts | $235+/mo | Pay-as-you-go |
